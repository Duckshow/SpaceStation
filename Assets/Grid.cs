...
public class Grid : MonoBehaviour {
    ...
    void CreateGrid() {
        ...
        for (int y = 0; y < _sqrtOfGridGraphics; y++) {
            ...
            for (int x = 0; x < _sqrtOfGridGraphics; x++) {
                ...
                gridGraphicsRenderers[_currentIndex].transform.position = new Vector3(_slicePosX, WORLD_HEIGHT, _slicePosY);
            }
        }
    ...
    void DrawTileToTexture(Tile _tile, Sprite _sprite) {
        ...
        else if (_tile.LocalGridY < sliceSizeY && _spriteHeight > TILE_RESOLUTION) {
