...
public class Tile : IHeapItem<Tile> {
    ...
    public static bool sTryTempCacheNeighbour_T(int _gridX, int _gridY) {
        sCachedNeighbour_T = _gridY < Grid.GridSize.y - 1 ? Grid.Instance.grid[_gridX, _gridY + 1] : null;
    ...
    public static bool sTryTempCacheNeighbour_R(int _gridX, int _gridY) {
        sCachedNeighbour_R = _gridX < Grid.GridSize.x - 1 ? Grid.Instance.grid[_gridX + 1, _gridY] : null;
    ...
    public static bool sTryTempCacheNeighbour_TL(int _gridX, int _gridY) {
        sCachedNeighbour_TL = _gridX > 0 && _gridY < Grid.GridSize.y - 1 ? Grid.Instance.grid[_gridX - 1, _gridY + 1] : null;
    ...
    public static bool sTryTempCacheNeighbour_TR(int _gridX, int _gridY) {
        sCachedNeighbour_TR = _gridX < Grid.GridSize.x - 1 && _gridY < Grid.GridSize.y - 1 ? Grid.Instance.grid[_gridX + 1, _gridY + 1] : null;
    ...
    public static bool sTryTempCacheNeighbour_BR(int _gridX, int _gridY) {
        sCachedNeighbour_BR = _gridX < Grid.GridSize.x - 1 && _gridY > 0 ? Grid.Instance.grid[_gridX + 1, _gridY - 1] : null;
