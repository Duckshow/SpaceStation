...
public class ObjectPlacer {
    ...
    public void Update() {
		...
		// 	// click
		// 	if (mouseStateLeft == Mouse.StateEnum.Click || isDeleting) { 
	    ...
	    // if (mouseStateLeft == Mouse.StateEnum.Hold || mouseStateRight == Mouse.StateEnum.Hold) {
        //     DetermineGhostPositions(_hasClicked: true, _snapToNeighbours: false);
        //     timeLastGhostUpdate = Time.time;
        // }

		// // click released
		// if (mouseStateRight == Mouse.StateEnum.Release || GetObjectToPlace() == null) { 
		// 	FinishRound();
		// }
    }
    ...
    private void PutDownPickedUp(Node _node) {
        ...
        // Mouse.GetInstance().TryDeselectSelectedObject();
