...
public class Grid : MonoBehaviour {
    ...
    //                _tile.IsBlocked_B = OtherTileIsBlockingPath(_neighbours[i]._Type_, _neighbours[i]._Orientation_, Tile.TileOrientation.Bottom);
    ...
    //                    _neighbours[i].IsBlocked_T = OtherTileIsBlockingPath(_tile._Type_, _tile._Orientation_, Tile.TileOrientation.Top);
    ...
    //                _tile.IsBlocked_L = OtherTileIsBlockingPath(_neighbours[i]._Type_, _neighbours[i]._Orientation_, Tile.TileOrientation.Left);

    //                if (_updateNeighbours) {
    //                    _neighbours[i].HasConnectable_R = _tile.CanConnect_L;
    //                    _neighbours[i].IsBlocked_R = OtherTileIsBlockingPath(_tile._Type_, _tile._Orientation_, Tile.TileOrientation.Right);
    ...
    //                _tile.IsBlocked_R = OtherTileIsBlockingPath(_neighbours[i]._Type_, _neighbours[i]._Orientation_, Tile.TileOrientation.Right);

    //                if (_updateNeighbours) {
    //                    _neighbours[i].HasConnectable_L = _tile.CanConnect_R;
    //                    _neighbours[i].IsBlocked_L = OtherTileIsBlockingPath(_tile._Type_, _tile._Orientation_, Tile.TileOrientation.Left);
    ...
    //                _tile.IsBlocked_T = OtherTileIsBlockingPath(_neighbours[i]._Type_, _neighbours[i]._Orientation_, Tile.TileOrientation.Top);

    //                if (_updateNeighbours) {
    //                    _neighbours[i].HasConnectable_B = _tile.CanConnect_T;
    //                    _neighbours[i].IsBlocked_B = OtherTileIsBlockingPath(_tile._Type_, _tile._Orientation_, Tile.TileOrientation.Bottom);
    ...
    //    _tile.SetTileType(_tile._Type_, _tile._Orientation_);
    ...
    //}
    //public void UpdateNeighbours(Tile _tile) {
    //    List<Tile> _neighbours = GetNeighbours(_tile.GridX, _tile.GridY);
    //    for (int i = 0; i < _neighbours.Count; i++) {
    //        UpdateTile(_neighbours[i], _updateNeighbours: false);
    //    }
    //}
